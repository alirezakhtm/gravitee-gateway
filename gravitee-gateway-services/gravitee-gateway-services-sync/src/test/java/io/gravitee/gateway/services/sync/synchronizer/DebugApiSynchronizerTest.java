...
public class DebugApiSynchronizerTest extends TestCase {
    ...
    public void shouldSynchronizeDebugEvents() {
        ...
        verify(eventManager, times(1)).publishEvent(eq(ReactorEvent.DEBUG), any(ReactableEvent.class));
    }
    ...
    public void shouldSynchronizeDebugEventsWithPagination() {
        ...
        verify(eventManager, times(2)).publishEvent(eq(ReactorEvent.DEBUG), any(ReactableEvent.class));
        verify(eventManager, times(2)).publishEvent(eq(ReactorEvent.DEBUG), any(ReactableEvent.class));
    }
    ...
    public void shouldSynchronizeALotOfDebugEvents() throws Exception {
        ...
        verify(eventManager, times(500)).publishEvent(eq(ReactorEvent.DEBUG), any(ReactableEvent.class));
    }
